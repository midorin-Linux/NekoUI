//! Web search and fetch tools for Nekoui.
//!
...
impl Tool for SearxngSearch {
    ...
    async fn call(&self, args: Self::Args) -> Result<Self::Output, Self::Error> {
        tracing::info!(target: "nekoui-tools", tool = Self::NAME, "tool called");
        ...
        tracing::debug!(target: "nekoui-tools", tool = Self::NAME, url = %request_url, "sending search request");
...
impl Tool for WebFetch {
    ...
    async fn call(&self, args: Self::Args) -> Result<Self::Output, Self::Error> {
        ...
        tracing::debug!(target: "nekoui-tools", tool = Self::NAME, url = %url, "fetching URL");
