...
use nekoui_config::loader::{
    Config, ConversationModel, DEFAULT_QDRANT_URL, EmbeddingModel, Memory, Parameters, Provider,
    SearxngConfig, SecretKey, ServerConfig, SummarizerModel, ToolPermissions, VectorDb,
};

// 笏笏 Provider Presets 笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏
...
// 笏笏 Embedding Presets 笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏
...
// 笏笏 Validation & Input Helpers 笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏
...
// --- Validation Functions 笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏
...
fn validate_discord_token(s: &str) -> Result<(), String> {
    ...
    if s.len() < 50 {
        return Err(
            "Token is too short 窶・Discord bot tokens are typically 50+ characters".to_string(),
        );
    }
    if !s
        .chars()
    ...
    {
        return Err(
            "Token contains invalid characters 窶・only alphanumeric, '.', '_', and '-' are allowed"
                .to_string(),
        );
    }
    Ok(())
...
// 笏笏 Display Helpers 笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏

fn print_header(step: usize, total: usize, title: &str) {
    println!();
    println!(
        "  {}",
        format!("笊絶武笊・Step {}/{} : {} ", step, total, title)
            .cyan()
            .bold()
    );
    println!();
...
// 笏笏 Step 1: Discord 笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏
...
fn step_discord() -> Result<(String, u64)> {
    ...
    let guild_id_str = validated_input(
        "  Guild / Server ID (optional 窶・leave empty for single-server mode)",
        None,
        validate_guild_id,
    )?;
...
// 笏笏 Step 2: AI Provider 笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏
...
// 笏笏 Step 3: Model Selection 笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏
...
fn step_models(
    ...
    let (embed_model_name, embed_dimension) = {
        ...
        if preset.model_name.is_empty() {
            ...
            let dim: u64 = dim
                .parse()
                .context("Invalid dimension 窶・expected a positive integer")?;
            (name, dim)
        } else {
...
// 笏笏 Step 4: Tool Permissions 笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏
...
fn step_tools() -> Result<ToolPermissions> {
    ...
    let searxng = if web_search {
        println!();
        println!("  {}", "笏笏笏 SearxNG Settings 笏笏笏".bold());
        println!();
...
// 笏笏 Advanced Settings Data 笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏
...
// 笏笏 Step 5: Advanced Settings (Optional) 笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏
...
fn step_advanced() -> Result<AdvancedConfig> {
    ...
    println!();
    println!("  {}", "笏笏笏 Memory Settings 笏笏笏".bold());
    println!();
    println!(
        "  {}",
    ...
    println!();
    println!("  {}", "笏笏笏 Model Parameters 笏笏笏".bold());
    println!();
    println!(
        "  {}",
    ...
    println!(
        "  {}",
        "笏笏笏 Summarizer Model Parameters 笏笏笏".bold()
    );
    println!();
...
// 笏笏 Summary 笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏
...
// 笏笏 Main Wizard Orchestrator 笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏

/// Run all 5 steps of the setup wizard and return a complete Config.
pub fn run_wizard() -> Result<Config> {
    // 笏笏 Step 1: Discord 笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏
    let (token, guild_id) = step_discord()?;

    // 笏笏 Step 2: AI Provider 笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏
    let (default_model, default_summarizer, base_url, api_key) = step_provider()?;

    // 笏笏 Step 3: Model Selection 笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏
    let (model_name, summarizer_model_name, embed_model_name, embed_dimension) =
        step_models(&default_model, &default_summarizer)?;

    // 笏笏 Step 4: Tool Permissions 笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏
    let tools = step_tools()?;

    // 笏笏 Step 5: Advanced Settings 笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏
    let advanced = step_advanced()?;

    // 笏笏 Summary & Confirm 笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏
    print_summary(
        token.len(),
        &base_url,
        &model_name,
    ...
    // 笏笏 Build Config 笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏
    // Reorder to minimize clones: fields used last get the move instead of clone
    let config = Config {
        server: ServerConfig {
            auth_token: Some(SecretKey::new(token)),
            ..Default::default()
        },
        provider: Provider {
